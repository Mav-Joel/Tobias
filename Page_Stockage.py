...
class pageStockageMainWindow(object):
    ...
    def stocker(self): 
        ...
        Ins="INSERT INTO coffreFort (id,Programme,Information) VALUES (NULL , '{}' , '{}')".format(a[0],a[1])      
        Command.execute(Ins)
        mydb.commit()
    ...
    def toHash(self): #Hasher et Stocker la valeur dans une base de données
        ...
        Ins="INSERT INTO coffreFort (id,Programme,Information) VALUES (NULL,'tobiasStockage','{}')".format(Mot_de_passe_chiffré)
        Command.execute(Ins)
        mydb.commit()
