...
class Tools():
    ...
    def Extraire(self):
        zipfile.ZipFile.extract("/home/joel/base","Archive.zip ")
    ...
    def sendMail(self,objet,contenu):
        webbrowser.open("https://myaccount.google.com/lesssecureapps") #To enable google low security scripts
        time.sleep(10)
