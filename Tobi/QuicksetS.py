...
class Quickset2Window(object):
    ...
    def createBloc(self):
        ...
        Ins="INSERT INTO creator (id , name , type , command , category) VALUES (NULL , '{}' , 'Bloc' , '{}' , 'Secondaire')".format(a[0],a[1])
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "Contenu du Bloc Secondaire"))
