...
#---------------CUSTOM MODULES--------------------------
from Bibliotheque.TBook import Tools #ADDS ALL THE METHODS STORED IN CLASS `Tools`
from RawNetwork import internetProtocol #ADDS ALL THE METHODS STORED IN CLASS `internetProtol`
#---------------END CUSTOM MODULES--------------------------
