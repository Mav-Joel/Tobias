...
class notesWindow(object):
    ...
    def save(self):
        ...
        with open(f"/home/{Utilisateur}/Archetype/Tobi/Admin/Notes/NOTES.txt","w") as variable : 
            variable.write(text)
            variable.close()

    def open(self):
        with open(f"/home/{Utilisateur}/Archetype/Tobi/Admin/Notes/NOTES.txt","r") as variable :
