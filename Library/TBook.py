...
class Tools():
    ...
    def getModuleData(self,searchingFor,fieldName='user'):
        with open(f"/Users/{user}/Archetype/Tobi/Settings/Main/Configurations.json","r") as config :
    ...
    def Rapport(self,Message):
        Database("rapportExecution","id","Programme","Information","NULL","Tobias",f"{Message}").insertInDatabase()
    ...
    def Extraire(self):
        zipfile.ZipFile.extract(f"/Users/{Utilisateur}/base","Archive.zip ")
