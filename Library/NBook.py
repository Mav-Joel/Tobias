    ...
    def myIp(self,toSearch):
        ...
        if toSearch == "ip":
            try :
                ...
                myIp = subprocess.getoutput("ifconfig | egrep 'inet '| awk '{print $2}' | tail -n1")

                return myIp

            finally : 
                
                osBasedIp = subprocess.getoutput("ifconfig | egrep 'inet '| awk '{print $2}' | tail -n1")
