...
class confWIndow(object):
            ...
            "Configurations": [
                {
                    ...
                    "Tobias" : {
                        "name": "MainTobias",
                        "local dbpassword": "GrpMaverick0",
                        "webServer": self.lineEdit.text(),
                        "distant dbpassword" : "" 
                    } 
                }
            ]
        }
        with open("/home/joel/Archétype/Tobi/Admin/Configurations.json","w") as config :
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Scan IP du réseau en arrière plan"))
        self.label_2.setText(_translate("MainWindow", "Détection du changement d\'adresse de l\'utilisateur en arrière plan"))
        self.label_3.setText(_translate("MainWindow", "Système d\'authentification SSH par liste blanche en arrière plan"))
        self.label_4.setText(_translate("MainWindow", "Vérification des clées publiques enregistrées en arrière plan "))
        self.label_5.setText(_translate("MainWindow", "Vérification de la Crontab en arrière plan"))
        self.label_6.setText(_translate("MainWindow", "Vérification des liaisons SSH établies en arrière plan"))
        self.label_7.setText(_translate("MainWindow", "Gestion des processus en arrière plan"))
        self.label_8.setText(_translate("MainWindow", "Informations sur les ordinateurs connus en arrière plan"))
        self.label_9.setText(_translate("MainWindow", "Vérification des activitées sur le réseau en arrière plan"))
