...
class handlerWindow(object):
    def apache(self):
        os.system("sudo /home/joel/Archétype/sysCommands/apacheHandler.bash {}".format(self.comboBox.currentText()))

    def tor(self):
        os.system("sudo /home/joel/Archétype/sysCommands/torHandler.bash {}".format(self.comboBox_2.currentText()))

    def ipTables(self):
        os.system("sudo /home/joel/Archétype/sysCommands/iptableHandler.bash {}".format(self.comboBox_3.currentText()))

    def sshService(self):
        os.system("sudo /home/joel/Archétype/sysCommands/sshHandler.bash {}".format(self.comboBox_4.currentText()))
