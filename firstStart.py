...
class firstStart():
    ...
    def getModuleData(self,searchingFor,fieldName='user'):
        with open(f"/home/{user}/Archétype/Tobi/Admin/Configurations.json","r") as config :
    ...
    def fromZeroToHero(self):
        ...
        for i in range (0,len(packages)):
            ...
            if a == f"/usr/bin/{packages[i]}" :
                print(f"{packages[i]} is installed")
            else :
    ...
    def rsaKeys(self):
        ...
        try :
            with open("/home/{}/.ssh/id_rsa.pub".format(user),"r") :
                pass
        except IOError:
...
class window(object):
    ...
    def storeData(self):
        ...
        with open("/home/joel/Archétype/Tobi/Admin/Network.csv","w") as variable :
            variable.write("address,state,action")
            variable.write("192.168.1.11,CONNECTED,TELL")
